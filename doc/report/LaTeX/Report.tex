...
cambio di range.
%
Risolta questa problematica riguardante il cambio di range ne ho dovuta affrontare una riguardante tutto il resto delle funzionalità di di una sorgente. Per agevolare la riusabilità ho optato per una classe più primitiva "Source" che riguardasse l'utilizzo di base lasciando a "FRSource"(Frequency Range Source) solamente le funzioni relative al range di frequenze:
%
\begin{figure}[H]
\centering{}
