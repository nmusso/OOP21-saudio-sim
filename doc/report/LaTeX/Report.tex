...
All'avvio l'applicazione si presenta nel seguente modo, con una configurazione già pronta
%
\begin{figure}[H]
\centering{}
...
\begin{figure}
\centering{}
\includegraphics[height=.5\linewidth]{img/guide/plugin1.png}
\includegraphics[height=.5\linewidth]{img/guide/plugin2.png}
